          ...
          <div className="lg:col-span-3 space-y-4">
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 border border-gray-200 shadow-sm">
              ...
              <div className="mb-4">
                ...
                <div className="mt-3">
                  <h5 className="font-medium text-xs text-gray-600 mb-1"><span className="inline-block mr-2 font-bold">A</span>pH of Ethanoic acid</h5>
                ...
                <div className="text-xs text-gray-600 mt-3 mb-2"><span className="inline-block mr-2 font-bold">B</span>When Sodium Ethanoate is added</div>
