          ...
          >
            ...
            {equipmentPositions.map((position) => {
              ...
              if (equipmentData) {
                ...
                const balanceImageUrl = "https://cdn.builder.io/api/v1/image/assets%2F3c8edf2c5e3b436684f709f440180093%2F67b66a202a8646f6afbf454f1f73eda7?format=webp&width=800";
